...
music = "phase2" --Either OGG or WAV. Extension is added automatically. Uncomment for custom music.
encountertext = "the second phase...." --Modify as necessary. It will only be read out in the action select screen.
nextwaves = {"bullettest_touhou", "original_attack"}
wavetimer = 4.0
arenasize = {275, 135}
flee = false
